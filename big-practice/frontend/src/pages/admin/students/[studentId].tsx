        ...
        <div className="flex flex-col gap-10  justify-center items-center md:gap-8 lg:gap-28 lg:flex-row">
          <div className="flex flex-col justify-center items-center gap-4 ">
            <Image
              src={avatarIcon}
              alt="avatarIcon"
              className="w-72 h-72 md:w-60 md:h-60 object-cover rounded-full lg:w-72 lg:h-72"
            />
            <div className="">
              <h3 className="text-[#1A1A1A] font-kumbh-sans font-bold">
                Kristin Watson
              </h3>
              <p className="font-bold text-[#A7A7A7] text-sm">
                Geology teacher
              </p>
            </div>
          </div>
          <div className="flex gap-6 flex-col lg:flex-col-reverse">
            <div className="flex justify-center items-center gap-28">
              ...
              <div className="flex flex-col">
                <p className="text-[#1A1A1A] font-bold font-kumbh-sans">
                  Gender
                </p>
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-[#1A1A1A] font-semibold text-center">
                About
              </h3>
              <p className="text-[#A7A7A7] text-center md:w-80 ">
