...
export default function SidebarMobile({ showSidebarMenu, onClose }: { showSidebarMenu: boolean, onClose: () => void }) {
    ...
    return (
        <div
            className={`fixed top-0 left-0 h-full w-full bg-[#83848b] bg-opacity-80 transform transition-transform ${showSidebarMenu ? 'translateX(0)' : 'translateX(-100%)'
                }`}
        >
